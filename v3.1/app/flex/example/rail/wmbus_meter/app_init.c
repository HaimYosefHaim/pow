...
const WMBUS_accessibility_t wmbus_accessibility = WMBUS_ACCESSIBILITY_LIMITED_ACCESS;
...
RAIL_Handle_t app_init(void)
{
  ...
  if ( wmbus_accessibility == WMBUS_ACCESSIBILITY_UNLIMITED_ACCESS ) {
