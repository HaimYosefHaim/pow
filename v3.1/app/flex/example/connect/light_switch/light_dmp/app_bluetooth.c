...
sl_bt_on_event(sl_bt_msg_t *evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_system_boot_id:
      ...
      APP_ASSERT(bt_status == SL_STATUS_OK,
    ...
    case sl_bt_evt_connection_opened_id:
      ...
      APP_INFO("Mobile device connected\n");
    ...
    case sl_bt_evt_gatt_server_user_write_request_id:
      ...
      if (gattdb_light_state_connect
        ...
        notify_connected_ble_device(SL_DIRECTION_BLUETOOTH, ble_device_address);
        APP_INFO("Toggle message from mobile device, light is %s\n",
        ...
        if (indication != NULL) {
          switch (indication->characteristic) {
            ...
            case gattdb_light_state_connect:
            {
              ...
              APP_WARNING(
                bt_status == SL_STATUS_OK,
                "sl_bt_gatt_server_send_characteristic_notification failed with 0x%04X\n",
                bt_status);
