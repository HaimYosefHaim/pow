...
static err_t low_level_output(struct netif *netif, struct pbuf *p)
{
  ...
  sl_wfx_host_allocate_buffer((void**)(&tx_buffer),
                              SL_WFX_TX_FRAME_BUFFER,
                              SL_WFX_ROUND_UP(framelength + padding, 64) + sizeof(sl_wfx_send_frame_req_t)); //12 is size of other data in buffer struct, user shouldn't have to care about this?
