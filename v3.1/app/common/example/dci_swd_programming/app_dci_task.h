...
/// EFR32xG21 user configuration buffer size
#define XG21_USER_CONF_SIZE             (7)

/// EFR32xG22 user configuration buffer size
#define XG22_USER_CONF_SIZE             (2)
...
#define INIT_SE_OTP_LENGTH              (0x00000028UL)
