...
#define EFR32_S2_DP_ID          (0x6BA02477)

/// Valid values for the AHB-AP IDR register
#define EFR32_S2_AHBAP_ID       (0x84770001)
...
/// Pin reset pulse width in micro seconds
#define RESET_PULSE     1000

/// Delay in micro seconds for soft or hard reset
...
/***************************************************************************//**
 * Reads the ID of AP #0 - This will be EFR32 S2 AHBAP ID if device is unlocked.
 *
