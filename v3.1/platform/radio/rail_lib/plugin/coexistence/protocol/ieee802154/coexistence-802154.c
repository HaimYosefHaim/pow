...
#define CONST_PTA_OPTIONS (~(PUBLIC_PTA_OPTIONS))
  ...
  && (SL_RAIL_UTIL_COEX_DEFAULT_PHY_SELECT_TIMEOUT < PTA_PHY_SELECT_TIMEOUT_MAX)
...
static void phySelectTick(void)
{
  if (phySelectTimeoutMs != PTA_PHY_SELECT_TIMEOUT_MAX && phySelectTimeoutMs != 0U && !RAIL_IsMultiTimerRunning(&ptaPhySelectTimer)) {
