...
class CALC_Demodulator_ocelot(ICalculator):
    ...
    def buildVariables(self, model):
        ...
        self._addModelVariable(model, 'preamble_detection_length', int, ModelVariableFormat.DECIMAL,
                               desc='Number of preamble bits to use for timing detection. Configure to minimize detection time for hopping or duty cycling scenarios.')
...
#TODO: Go through these and decide if they still apply for Ocelot
    ...
    def calc_dsa_enable(self,model):
        ...
        if fast_detect_enable and (demod_select == model.vars.demod_select.var_enum.LEGACY):
            dsa_enable = True
        else:
            dsa_enable = False
