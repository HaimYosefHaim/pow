...
class Profile_Base_Ocelot(Profile_Base):
    ...
    def build_optional_profile_inputs(self, model, profile):
        ...
        IProfile.make_optional_input(profile, model.vars.manchester_mapping, "symbol_coding",
        ...
        IProfile.make_optional_input(profile, model.vars.lo_injection_side, "operational_frequency",
                                     default=model.vars.lo_injection_side.var_enum.HIGH_SIDE,
    ...
    def build_advanced_profile_inputs(self, model, profile):
        ...
        IProfile.make_linked_io(profile, model.vars.preamble_detection_length, "preamble",
                                'Length of preamble to be used for detection', value_limit_min=0, value_limit_max=2097151)
