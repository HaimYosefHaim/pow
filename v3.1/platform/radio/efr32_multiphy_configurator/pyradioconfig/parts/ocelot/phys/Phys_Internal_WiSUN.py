...
class PHYS_Internal_WiSUN_Ocelot(IPhy):
    ...
    # Owner: Young-Joon Choi
    # For WiSun test with Antenna Diversity Enabled
    def PHY_Internal_WISUN_920MHz_2GFSK_50kbps_1b_JP_antdiv(self, model, phy_name=None):
        # modify Studio phy
        phy = PHYS_IEEE802154_WiSUN_Ocelot().PHY_IEEE802154_WISUN_920MHz_2GFSK_50kbps_1b_JP(model,
                                                                                            phy_name='PHY_Internal_WISUN_920MHz_2GFSK_50kbps_1b_JP_antdiv')
        phy.profile_inputs.antdivmode.value = model.vars.antdivmode.var_enum.PHDEMODANTDIV
        phy.profile_inputs.skip2ant.value = model.vars.skip2ant.var_enum.SKIP2ANT
    ...
    # Owner: Young-Joon Choi
    # For WiSun test with Antenna Diversity Enabled
    def PHY_Internal_WISUN_920MHz_2GFSK_100kbps_2b_JP_antdiv(self, model, phy_name=None):
        # modify Studio PHY
        phy = PHYS_IEEE802154_WiSUN_Ocelot().PHY_IEEE802154_WISUN_920MHz_2GFSK_100kbps_2b_JP(model,
                                                                                             phy_name='PHY_Internal_WISUN_920MHz_2GFSK_100kbps_2b_JP_antdiv')
