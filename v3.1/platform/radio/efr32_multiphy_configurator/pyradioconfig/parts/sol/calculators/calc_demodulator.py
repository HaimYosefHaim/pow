...
class Calc_Demodulator_Sol(CALC_Demodulator_ocelot):
    ...
    def calc_mod_type_reg(self, model):
        ...
        if modformat == model.vars.modulation_type.var_enum.OFDM:
    ...
    def calc_demod_sel(self, model):
        ...
        if model.vars.demod_select._value_forced == model.vars.demod_select.var_enum.SOFT_DEMOD or (modtype == model.vars.modulation_type.var_enum.OFDM) :
