...
class Calc_Global_Sol(CALC_Global_ocelot):
    ...
    def buildVariables(self, model):
        ...
        self._addModelRegister(model, 'RFFPLL0.RFFPLLCAL1.DIVR', int, ModelVariableFormat.HEX)
        ...
        self._addModelRegister(model, 'CW.CWCFG1.FREQ', int, ModelVariableFormat.HEX)
        ...
        # LEGOQPSK Peripheral
        self._addModelRegister(model, 'LEGOQPSK.LEGOQPSKCFG.MODULATION', int, ModelVariableFormat.HEX)
        self._addModelRegister(model, 'LEGOQPSK.LEGOQPSKCFG.CHIPRATE', int, ModelVariableFormat.HEX)
        self._addModelRegister(model, 'LEGOQPSK.LEGOQPSKCFG.BANDFREQMHZ', int, ModelVariableFormat.HEX)
        ...
        self._addModelRegister(model, 'SUNFSK.SUNFSKCFG1.OSR', int, ModelVariableFormat.HEX)
