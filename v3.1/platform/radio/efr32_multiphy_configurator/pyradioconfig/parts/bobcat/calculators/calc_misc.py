...
class Calc_Misc_Bobcat(CALC_Misc_ocelot):
    ...
    def calc_misc(self, model):
        ...
        self._reg_write(model.vars.MODEM_ADPC2_ADPCSIGAMPTHR, 0)
        ...
        self._reg_write(model.vars.MODEM_ADCTRL2_ADCTRL2, 129)
        self._reg_write(model.vars.MODEM_ADCTRL1_ADCTRL1, 0)
        self._reg_write(model.vars.MODEM_ADPC1_ADPCEN, 0)
        self._reg_write(model.vars.MODEM_ADPC1_ADPCWNDSIZECHIP, 32)
        self._reg_write(model.vars.MODEM_ADPC1_ADPCCORROFFSETCHIP, 0)
        self._reg_write(model.vars.MODEM_ADPC1_ADPCTIMINGBAUDS, 32)
        self._reg_write(model.vars.MODEM_ADPC1_ADPCWNDCNT, 1)
        self._reg_write(model.vars.MODEM_ADPC2_ADPCCORRSAMPLES, 160)
