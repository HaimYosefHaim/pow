...
def build_modem_regs_sol_only(model, profile, family):
    ...
    profile.outputs.append(ModelOutput(model.vars.RFFPLL0_RFFPLLCAL1_DIVR, '',         ModelOutputType.SVD_REG_FIELD, readable_name='RFFPLL0.RFFPLLCAL1.DIVR'           ))
    ...
    profile.outputs.append(ModelOutput(model.vars.CW_CWCFG1_FREQ, '', ModelOutputType.SVD_REG_FIELD, readable_name='CW.CWCFG1.FREQ'))
    ...
    #LEGOQPSK Peripheral
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG_MODULATION, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG.MODULATION'))
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG_CHIPRATE, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG.CHIPRATE'))
    profile.outputs.append(ModelOutput(model.vars.LEGOQPSK_LEGOQPSKCFG_BANDFREQMHZ, '', ModelOutputType.SVD_REG_FIELD, readable_name='LEGOQPSK.LEGOQPSKCFG.BANDFREQMHZ'))
    ...
    profile.outputs.append(ModelOutput(model.vars.SUNFSK_SUNFSKCFG1_OSR, '', ModelOutputType.SVD_REG_FIELD, readable_name='SUNFSK.SUNFSKCFG1.OSR'))
