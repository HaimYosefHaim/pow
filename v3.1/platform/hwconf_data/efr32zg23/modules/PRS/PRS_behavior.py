...
PRS_SOURCE_TO_SIGNALS_MAP = {
    ...
    'ACMP0': ['ACMP0_OUT', ],
    'ACMP1': ['ACMP1_OUT', ],
    'VDAC0L': ['VDAC0L_CH0WARMEDOUTASYNC', 'VDAC0L_CH1WARMEDOUTASYNC', 'VDAC0L_CONVDONEOUTASYNCCH0', 'VDAC0L_CONVDONEOUTASYNCCH1', 'VDAC0L_INTERNALTIMEROVERFLOWOUTASYNC', 'VDAC0L_REFRESHTIMEROVERFLOWOUTASYNC', 'VDAC0L_DACDEBUGOUT0', 'VDAC0L_DACDEBUGOUT1', ],
    ...
    'LESENSE': ['LESENSE_DECOUT0', 'LESENSE_DECOUT1', 'LESENSE_DECOUT2', 'LESENSE_DECOUT3', 'LESENSE_MEASACT', ],
    'HFXO0L': ['HFXO0L_STATUS', 'HFXO0L_STATUS1', 'HFXO0L_PKDETSTATUS', 'HFXO0L_BUFOUTPKDETSTATUS', 'HFXO0L_STATE0', 'HFXO0L_STATE1', 'HFXO0L_STATE2', 'HFXO0L_STATE3', ],
    'HFXO0': ['HFXO0_STATE4', ],
    ...
    'EUSART2': ['EUSART2_EUSARTDBG0', 'EUSART2_EUSARTDBG1', 'EUSART2_EUSARTDBG2', 'EUSART2_EUSARTDBG3', 'EUSART2_EUSARTDBG4', 'EUSART2_EUSARTDBG5', 'EUSART2_EUSARTDBG6', 'EUSART2_EUSARTDBG7', ],
    ...
    'LCD': ['LCD_LCDCLKDIAG', 'LCD_LCDCOMPOUT', ],
