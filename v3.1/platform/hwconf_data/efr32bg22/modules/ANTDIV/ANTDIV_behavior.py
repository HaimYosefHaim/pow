...
class ANTDIV(ExporterModel.Module):
    ...
    def modem_or_antdiv_sel_nsel_visible(studio_module, property, state):
        ...
        runtime_phy_select = RuntimeModel.get_property_reference("HAL_ANTDIV_RX_RUNTIME_PHY_SELECT", module=studio_module)
        if rx_mode == 'HAL_ANTENNA_MODE_DISABLED' and not runtime_phy_select:
